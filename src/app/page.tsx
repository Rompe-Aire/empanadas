    ...
    <main className="w-full">
      ...
      <section className="flex flex-col gap-4 py-8">
        ...
        <form action="" className="flex flex-col gap-4 items-center" id="contacto">
          ...
          <Input isRequired type="telefono" placeholder="Telefono" className="w-2/4 bg-white max-md:w-10/12" />
          <Textarea isRequired placeholder="Mensaje" className="w-2/4 bg-white max-md:w-10/12" />
